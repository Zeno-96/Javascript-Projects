...
function get_todos() {
    ...
    // ---If the input is not nul then JSON.parse will communicate with the web browser to make the task a JavaScript object.---
    if (todos_str !== null) {
...
// ---This function keeps the tasks permanently displayed on the scren.---
function show() {
