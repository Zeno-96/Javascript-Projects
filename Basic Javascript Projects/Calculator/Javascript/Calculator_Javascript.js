...
function Input_Decimal(dot) {
    ...
    if (!Calculator.Display_Value.includes(dot)) {
        // ---We are saying that if the Display_Value does not contain a decimal point, wewant to add a decimal point.---
...
function Handle_Operator(Next_Operator) {
    ...
    // ---When an operator key is pressed we convert the current number displayed on the screen to a number and then store the result in Calculator.First_Operand and if it doesn't already exist.---
    ...
    if (First_Operand == null) {
        ...
        // ---This will remove the trailing 0's.---
