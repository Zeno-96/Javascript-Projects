...
// ---This function is for placing an X or and O in a square.---
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        // ---This calls a fundtion to check for any win conditions.---
        checkWinConditions();
...
function checkWinConditions() {
    ...
    // ---This condition checks for a tie. If none of the above conditions are met and 9 squares the code executes.---
...
function drawWinLine(coordX1, coordY1, coordX2, coordY2) {
    // ---This line access our HTML convas element.---
    ...
    // ---Tis function interacts with the camvas.---
